...
public class PercolationStats {
  ...
  private static final double MAGIC_NUMBER = 1.96d;
   ...
   * Test client.
   *
   * @param args - the arguments of the client. First - grid size, second - the number of trials.
   * @throws IllegalArgumentException if arguments are not corresponding to description.
   */
